...
export const shopItems: ShopItem[] = [
  ...
  },
  {
    ...
    space: 1,
    category: 'weapon',
    description: '12号霰弹。末世后再也买不到，每一发都要省着用。',
    icon: '🎯',
  ...
  },
  {
    ...
    icon: '💊',
    hidden: '治疗效果：治疗<感染>状态，阻止HP持续下降。预防性服用可降低伤口感染概率50%。一瓶可使用5次。'
  },
  {
    id: 'firstaid',
    name: '急救包',
  ...
  },
  {
    ...
    icon: '🎮',
    hidden: '情绪效果：有电时使用，SAN+15（沉浸式娱乐）。停电后无法使用。可缓解长期隔离带来的精神压力。使用时会忘记时间流逝，可能错过重要事件（剧情分支）。'
  },
  {
    id: 'laoganma',
    name: '老干妈',
    ...
    icon: '🌶️',
    hidden: '情绪效果：配合食物使用时额外SAN+5（美味加成）。能让压缩饼干、方便面等变得可口。可用于交易，对中国幸存者吸引力极大。'
  },
  {
    id: 'book',
    name: '小说',
  ...
  },
  {
    ...
    icon: '🚬',
    hidden: '情绪效果：使用时SAN+10（短期缓解焦虑）。交易价值极高，可换取食物、情报等。长期使用可能产生依赖（剧情分支）。在紧张时刻使用可稳定情绪。'
  },
  {
    id: 'wine',
    name: '红酒',
