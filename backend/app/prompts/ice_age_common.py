...
### 非危机日事件类型（AI 应轮换选择）
以下是非危机日（has_crisis=false）时，narration 可简略描写的内容类型（50字以内）：

1. **外出探索** - 在避难所附近搜索物资、发现其他幸存者的踪迹（脚印、遗留物）
2. **避难所活动** - 维护和加固避难所、整理物资、使用娱乐物品
3. **广播与信息** - 收音机传来的消息（救援进度、其他幸存者）
4. **他人踪迹** - 听到外面的声音、发现门外有人来过的痕迹、远处的烟火
5. **天气与环境** - 暴风雪来袭/停歇、气温骤降的体感
